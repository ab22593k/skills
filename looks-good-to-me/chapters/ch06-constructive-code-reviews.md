...
* **Objective Justification:** Every change request should explain *why* it is necessary, citing style guides, security, performance, or correct logic.
...
* **The 5P Comment Process:**
  ...
  - **Ponder:** Ask *why* the change is needed and if it is objective.
