...
RST teaches that a tester should spend significant time on testability. If testing is slow, the first task is to _fix the testing_, not just test more slowly.
...
- **Tools**: Better tools don't improve testability; they _exploit_ it.
