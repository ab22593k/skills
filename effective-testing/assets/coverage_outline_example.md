...
- [ ] Caching layer (Redis) - _not yet implemented_
...
- [x] URL expiration
- [ ] Bulk URL creation - _deferred to next sprint_
...
- [ ] Data URIs - _needs investigation_
...
- [x] Firefox (latest)
- [x] Safari (latest)
- [ ] Edge - _scheduled for next session_
- [ ] Mobile browsers - _not yet tested_

### Operating Systems

- [x] Windows 11
- [x] macOS Sonoma
- [ ] Linux - _low priority_
- [ ] iOS - _pending_
- [ ] Android - _pending_
...
- [ ] Scenario testing (user workflows) - _planned_
- [x] Claims testing (vs. requirements doc)
- [ ] Risk testing (security focus) - _scheduled_
