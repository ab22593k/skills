...
This chapter sets the foundation for all anti-patterns (Ch2-4) by explaining _why_ familiar patterns fail. The Bad Calculator project introduced here is the running example through Part 1.
